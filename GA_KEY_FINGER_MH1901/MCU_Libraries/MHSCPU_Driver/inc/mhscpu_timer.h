...
#define IS_TIM_MODULE_PERIPH(MODULE)				(MODULE == TIMM0)
...
#define IS_TIM_PERIPH(PERIPH)						(PERIPH == TIM_0 || PERIPH == TIM_1 ||\
													PERIPH == TIM_2 || PERIPH == TIM_3 ||\
													PERIPH == TIM_4 || PERIPH == TIM_5)
...
#define IS_TIM_PWM_PERIPH(PERIPH)					(PERIPH == TIM_0 || PERIPH == TIM_1 ||\
													PERIPH == TIM_2 || PERIPH == TIM_3 ||\
													PERIPH == TIM_4 || PERIPH == TIM_5)
