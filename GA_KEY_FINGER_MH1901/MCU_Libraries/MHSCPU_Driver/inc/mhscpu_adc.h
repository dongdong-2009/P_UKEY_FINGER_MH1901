...
#define     FLASH_OTP1      ((uint32_t *)(0x02001000 - 8))
#define     FLASH_OTP2      ((uint32_t *)(0x02001000 - 4))
    
#define ADC_START_BIT       BIT(8)
#define ADC_IRQ_EN_BIT      BIT(5)
#define ADC_RATE_MASK       (0x3 << 3)
#define ADC_CHAN_MASK       (0x7 << 0)
...
extern uint32_t ADC_Filt_Average(ADC_ChxTypeDef ADC_Channel);
/* Exported variables -------------------------------------------------------*/
/* Exported types -----------------------------------------------------------*/
