...
#define GPIO_PF_ALT     (*(uint32_t *)(0x40026194))
#define GPIO_PF_OEN     (*(uint32_t *)(0x40026058))
#define GPIO_PF_BSRR    (*(uint32_t *)(0x40026054))
