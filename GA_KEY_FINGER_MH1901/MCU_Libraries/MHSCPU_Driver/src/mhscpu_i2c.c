...
extern void SYSCTRL_I2S_Reset(I2C_TypeDef* I2Cx);

void I2C_DeInit(I2C_TypeDef* I2Cx)
{
	if (I2C0 == I2Cx)
		SYSCTRL_I2S_Reset(I2Cx);
}
...
{
	I2CMode_TypeDef I2CModeRet;

	if ((I2Cx->IC_CON & I2C_IC_CON_MASTER_MODE) && (I2Cx->IC_CON & I2C_IC_CON_SLAVE_DISABLE))
	{
		I2CModeRet = I2C_Mode_Master;
	}
	else
	{
		I2CModeRet = I2C_Mode_Slave;
	}
	return I2CModeRet;
}
...
void I2C_SendBytes(I2C_TypeDef* I2Cx, uint8_t* Data, uint32_t DataLen, I2CDataEndCondition_TypeDef DataCondition)
{
	...
	while(DataLen)
	{
		...
		{
			I2C_SendData(I2Cx, *Data, I2C_DataEndCondition_None);		//it is same as I2C_SendData_Slave
		}
		Data++;
		DataLen--;
	}
