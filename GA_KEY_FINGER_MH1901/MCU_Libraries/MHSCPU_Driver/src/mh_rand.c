...
#define MH_TRNG_RNG_AMA_PD_TRNG1_Pos					(31)
#define MH_TRNG_RNG_AMA_PD_TRNG1_Mask					(0x01U<<MH_TRNG_RNG_AMA_PD_TRNG1_Pos) 
...
#define MH_TRNG_RNG1_CSR_S128_Pos						(1)
#define MH_TRNG_RNG1_CSR_S128_Mask						(0x01U<<MH_TRNG_RNG1_CSR_S128_Pos)
#define MH_TRNG_RNG0_CSR_ATTACK_Pos						(2)
#define MH_TRNG_RNG0_CSR_ATTACK_Mask					(0x01U<<MH_TRNG_RNG0_CSR_ATTACK_Pos)
#define MH_TRNG_RNG1_CSR_ATTACK_Pos						(3)
#define MH_TRNG_RNG1_CSR_ATTACK_Mask					(0x01U<<MH_TRNG_RNG1_CSR_ATTACK_Pos)
...
__STATIC_INLINE void mh_trand_init(void)
{
	...
	MH_TRNG->RNG_AMA &= ~MH_TRNG_RNG_AMA_PD_TRNG1_Mask;
}

__STATIC_INLINE void mh_trand_start(void)
{
	MH_TRNG->RNG_CSR &= ~MH_TRNG_RNG0_CSR_S128_Mask;
	MH_TRNG->RNG_CSR &= ~MH_TRNG_RNG1_CSR_S128_Mask;
}
...
void TRNG_IRQHandler(void)
{
	 ...
	 *	check if the TRNG is attacked
	 */
	if ((MH_TRNG->RNG_CSR & MH_TRNG_RNG0_CSR_ATTACK_Mask) ||(MH_TRNG->RNG_CSR & MH_TRNG_RNG1_CSR_ATTACK_Mask))
	{
	...
	else
	{
		...
		//printf("%02X", (unsigned char)MH_TRNG->RNG_CSR);
		for (j = 0; j < 2; j++)
		{
			if (MH_TRNG->RNG_CSR & (1 << j))
			{
				if (j == 0)
				{
					p = &MH_TRNG->RNG0_DATA;
			...
			if (MH_TRNG->RNG_CSR & (1 << (MH_TRNG_RNG0_CSR_ATTACK_Pos + j)))
			{
				g_trng_buf.attacked = MH_RAND_BUFFER_ATTACKED;
			}
			else
