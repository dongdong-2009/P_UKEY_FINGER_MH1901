...
/**
  * ½á¹¹ËµÃ÷£ºµ÷ÊÔ¿ØÖÆ¼Ä´æÆ÷(USBPHY_CR1)½á¹¹
  * Æ«ÒÆµØÖ·£º0x0108 
  * ³õ Ê¼ Öµ£º0x004921AE
  * Êô    ÐÔ£ºRW
  * ¿í    ¶È£º32bit
...
/**
  * ½á¹¹ËµÃ÷£ºµ÷ÊÔ¿ØÖÆ¼Ä´æÆ÷(USBPHY_CR3)½á¹¹
  * Æ«ÒÆµØÖ·£º0x010C
  * ³õ Ê¼ Öµ£º0x00000000
  * Êô    ÐÔ£ºRW
  * ¿í    ¶È£º32bit
...
typedef union _USBPHY_CR3_TypeDef
{
    uint32_t d32;
    struct{
        uint32_t idpullup	                : 1;    /* ÓÃÓÚ²Ù×÷ USB PHYµÄidpullup£¬Æô¶¯PHYÌ½²âID×´Ì¬ */
        uint32_t iddig                      : 1;    /* PHY Êä³öµÄID×´Ì¬ÐÅºÅ£¬ÓÃÓÚÈí¼þ²éÑ¯ */
