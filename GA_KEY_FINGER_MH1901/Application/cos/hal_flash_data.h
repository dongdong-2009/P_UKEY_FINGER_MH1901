...
#define   	FLASH_BASE_ADDR			0x1001000
#define 	DATASTART				(FLASH_BASE_ADDR+0x1C000)				//片内存储空间起始地址
...
//#define	
#define 	MFSTART 				(FLASH_BASE_ADDR+0x1E800)				//MF起始，即COS计时位置
#define 	MFEND					(FLASH_BASE_ADDR+0x2E800)				//COS结束位置
#define	COS_SIZE				(MFEND-MFSTART)//		//COS大小64K

#define  	SECTOR_NUM			(COS_SIZE / SECTOR_SIZE)
//#define 	SECTOU_LIST_SIZE		((SECTOR_NUM+7)/8)
#define 	DATAEND				(FLASH_BASE_ADDR+0x2E800)				//片内存储空间结束地址
